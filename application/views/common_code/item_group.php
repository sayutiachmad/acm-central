          ...
          <div id="tree" style="overflow-x: auto;height: 400px;">
            ...
            <ul>
              <?php foreach ($item_group as $itg_1) { ?>
              		...
              		<?php if($itg_1[FIELD_COMMON_CODE_PARENT]==0 && $itg_1[FIELD_COMMON_CODE_HEAD]=="ITG"){ ?>
	                    ...
	                    <?php if($itg_1['total_child']>0){ ?>
		                  	...
		                  	<ul>
		                  		...
		                  		<?php foreach ($item_group as $itg_2) { ?>
		                  			...
		                  			<?php if($itg_2[FIELD_COMMON_CODE_PARENT] == $itg_1[FIELD_COMMON_CODE_HEAD] && $itg_2[FIELD_COMMON_CODE_DESCRIPTION_3]=="ITG"){ ?>
		                  					...
		                  					<?php if($itg_2['total_child']>0){ ?>
		                  						...
		                  						<ul>
		                  							...
		                  							<?php foreach ($item_group as $itg_3) { ?>
		                  								...
		                  								<?php if($itg_3[FIELD_COMMON_CODE_PARENT] == $itg_2[FIELD_COMMON_CODE_HEAD] && $itg_3[FIELD_COMMON_CODE_DESCRIPTION_3]=="ITG"){ ?>
		                  										...
		                  										<?php if($itg_3['total_child']>0){ ?>
		                  											...
		                  											<ul>
		                  												...
		                  												<?php foreach ($item_group as $itg_4) { ?>
		                  													...
		                  													<?php if($itg_4[FIELD_COMMON_CODE_PARENT] == $itg_3[FIELD_COMMON_CODE_HEAD] && $itg_4[FIELD_COMMON_CODE_DESCRIPTION_3]=="ITG"){ ?>
  			    ...
  			    <div class="modal-body">
  			            ...
  			            <div class="row clearfix" style="display: none;">
  			                ...
  			                <div class="col-12 col-md-8">
  			                    <div class="form-group">
  			                        <div class="form-line">
  			                            <input type="text" name="cc_desc_3_" class="form-control" placeholder="Description" autocomplete="false" readonly value="ITG">
  			                        </div>
  			                    </div>
  			                </div>
  			            </div>
